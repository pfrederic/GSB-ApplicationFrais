 ...
 */
  ...
  require($repInclude . "_enteteVisiteur.inc.html");
...
<?php          
            ...
            $noMois = substr($moisSaisi,0,4)."-".substr($moisSaisi, 4, 2);
            $req = obtenirReqEltsHorsForfaitFicheFrais($noMois, obtenirIdUserConnecte());
